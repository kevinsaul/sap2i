<header>
    <nav>
        ...
        <a href="{{ pll_home_url() }}" class="logo"><img src="{!! get_template_directory_uri() . '/assets/images/logo-sap2i.png' !!}"></a>
